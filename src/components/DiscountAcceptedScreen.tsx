...
interface DiscountAcceptedScreenProps {
  onClose: () => void;
  onBack: () => void;
  onLandDreamRole: () => void;
}

export default function DiscountAcceptedScreen({
  onClose,
  onBack,
  onLandDreamRole,
}: DiscountAcceptedScreenProps) {
  const [isVisible, setIsVisible] = useState(false);
  const [isAnimating, setIsAnimating] = useState(false);

  useEffect(() => {
    console.log('DiscountAcceptedScreen component mounted and useEffect triggered');
    setIsVisible(true);
    setIsAnimating(true);
