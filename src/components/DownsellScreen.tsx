...
export default function DownsellScreen({
  ...
  useEffect(() => {
    console.log('DownsellScreen component mounted and useEffect triggered');
    setIsVisible(true);
    setIsAnimating(true);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4 z-50">
      ...
      <div
        className={`bg-white rounded-[20px] w-full max-w-[320px] sm:max-w-[480px] md:max-w-[640px] lg:max-w-[1000px] h-auto min-h-[481px] sm:min-h-[500px] lg:min-h-[481px] max-h-[90vh] flex flex-col lg:flex-row relative overflow-hidden shadow-2xl transition-all duration-500 transform ${
          isVisible
        ...
        <div className="absolute top-0 left-0 right-0 bg-white border-b border-gray-200 px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-center justify-between z-10">
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            <div className="flex space-x-1">
              <div className="w-2 h-2 sm:w-3 sm:h-2 bg-gray-500 rounded-sm"></div>
              <div className="w-2 h-2 sm:w-3 sm:h-2 border-2 border-gray-300 rounded-sm"></div>
              <div className="w-2 h-2 sm:w-3 sm:h-2 border-2 border-gray-300 rounded-sm"></div>
            </div>
