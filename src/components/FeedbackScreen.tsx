...
export default function FeedbackScreen({
  ...
  const isFormValid = currentCharacters >= minCharacters;
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4 z-50">
      ...
      <div 
        className={`bg-white rounded-[20px] w-full max-w-[320px] sm:max-w-[480px] md:max-w-[640px] lg:max-w-[1000px] h-auto min-h-[417px] sm:min-h-[400px] lg:min-h-[417px] max-h-[90vh] flex flex-col lg:flex-row relative overflow-hidden shadow-2xl transition-all duration-500 transform ${
          isVisible 
