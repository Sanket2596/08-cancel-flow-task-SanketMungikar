...
export default function VisaScreen({
  ...
  // Form validation: requires immigration lawyer selection and visa type if "Yes" is selected
  const isFormValid = hasImmigrationLawyer !== '' && (hasImmigrationLawyer === 'no' || (hasImmigrationLawyer === 'yes' && visaType.trim().length > 0));
  ...
  const handleRadioChange = (value: string) => {
    ...
    // Clear visa type when switching to "No"
    if (value === 'no') {
      setVisaType('');
    }
  };
          ...
          <div className="lg:hidden flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col justify-start px-3 sm:px-4 pt-16 sm:pt-20 pb-4 sm:pb-6">
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Congratulatory Text with delay and responsive sizing */}
          ...
          <div className="hidden lg:flex flex-1">
            ...
            <div className="w-[60%] flex flex-col justify-center px-12 py-8">
              <div className="space-y-6">
                ...
                {/* Congratulatory Text with delay */}
                ...
                {/* Finish Button with enhanced hover effects */}
                <div className={`pt-4 transition-all duration-500 delay-400 ${
                  isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                }`}>
                  <button
                    onClick={onComplete}
                    className="w-full py-4 px-6 bg-[#8952fc] text-white rounded-lg font-medium transition-all duration-300 hover:bg-[#7b40fc] hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
                  >
                    Finish
                  </button>
                </div>
        ...
        <div className="lg:hidden flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col justify-start px-3 sm:px-4 pt-16 sm:pt-20 pb-4 sm:pb-6">
            <div className="space-y-4 sm:space-y-6">
              ...
              {/* Conditional Visa Type Question - Only shows when "Yes" is selected */}
              ...
              <div className={`pt-3 sm:pt-4 transition-all duration-500 delay-600 ${
                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}>
                <button
        ...
        <div className="hidden lg:flex flex-1">
          ...
          <div className="w-[60%] flex flex-col justify-start px-12 pt-16 pb-6">
            <div className="space-y-6">
              ...
              <div className={`pt-6 transition-all duration-500 delay-600 ${
                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}>
                <button
                  onClick={handleComplete}
